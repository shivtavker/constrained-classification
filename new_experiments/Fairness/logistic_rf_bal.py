...
for name in ["compas", "crimes", "default", "lawschool", "adult"]:
    ...
    np.save("ballogreg_" + name + "_train_scores.npy", train_scores)
    np.save("ballogreg_" + name + "_test_scores.npy", test_scores)

    np.save("ballogreg_" + name + "_train_cons.npy", train_cons_val)
    np.save("ballogreg_" + name + "_test_cons.npy", test_cons_val)
