...
# for d in ["MACHO"]:
    ...
    np.save("ballogreg_" + d + "_train_scores.npy", train_scores)
    np.save("ballogreg_" + d + "_test_scores.npy", test_scores)

    np.save("ballogreg_" + d + "_train_cons.npy", train_cons)
    np.save("ballogreg_" + d + "_test_cons.npy", test_cons)
